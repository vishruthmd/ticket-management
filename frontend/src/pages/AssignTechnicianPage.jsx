          ...
          <div className="card-body">
            <div className="text-center mb-6">
              ...
              <p className="text-sm text-gray-500 mt-2">
                List of open tickets to assign technicians
              </p>
            </div>
        ...
        <div className="fixed inset-0 bg-black bg-opacity-60 flex items-center justify-center z-50 animate-fadeIn">
          ...
          >
            ...
            <div className="flex justify-end gap-3 pt-2 border-t">
              ...
              <button
                className={`px-4 py-2 text-white bg-blue-600 hover:bg-blue-700 rounded-md transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 flex items-center ${
                  assigning ? "opacity-75" : ""
                }`}
